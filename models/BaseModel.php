...
abstract class BaseModel
{
    ...
    {
        $statement = $this->db->prepare("SELECT * FROM {$this->table} WHERE slug = :slug LIMIT 1");
    ...
    public function update(int $id, array $data): bool
    {
        ...
        $statement = $this->db->prepare("UPDATE {$this->table} SET {$set} WHERE {$this->primaryKey} = :{$this->primaryKey}");
